<template>
    <div class="wrapper">
        <div
            style="margin: 150px auto; background-color: #fff;width: 400px;height:450px;padding:20px;border-radius:10px">
            ...
            <el-form :model="user" :rules="rules" ref="userForm">
                ...
                <el-form-item prop="nickname">
                    <el-input placeholder="请输入昵称" size="medium" style="margin:10px 0" prefix-icon="el-icon-user" v-model="user.nickname">
                    </el-input>
                </el-form-item>
